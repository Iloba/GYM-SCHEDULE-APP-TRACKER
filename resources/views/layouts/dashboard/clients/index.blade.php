...
<body class="app">
                        ...
                        <div class="app-utilities col-auto">
                            ...
                            <div class="app-utility-item app-user-dropdown dropdown">
                                <a class="dropdown-toggle" id="user-dropdown-toggle" data-bs-toggle="dropdown" href="#"
                                    role="button" aria-expanded="false"><i class="fas fa-user"></i></a>
                                <ul class="dropdown-menu" aria-labelledby="user-dropdown-toggle">
                                    ...
                                    <li>
                                        <a class="dropdown-item" href="{{ route('client.logout') }}" onclick="event.preventDefault();
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="{{ route('update.password', auth('client')->user()->id) }}" method="POST">
                            @csrf
    ...
    <footer class="app-footer">
        <div class="container text-center py-3">
            ...
            <small class="copyright">Designed with
                ...
                <a class="" href="https://rooah.xyz" target="_blank">Rooah!</a></small>
        </div>
    </footer>
    ...
    <script src="{{
            asset('js/plugins/bootstrap/js/bootstrap.min.js')
        }}"></script>
